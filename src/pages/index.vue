<template>
  <div class="index">
    <div id="fullpage">
      ...
      <div class="section">
        <div class="index_item--footerBox">
          <div class="index_item--footer">
            <div class="sentenceBlock">
              立即发布您的项目！
            </div>
      ...
      whyChooseArr:[
        {
          ...
          title:'优质人才',
          isHover:false,
          description:'人才来自著名互联网公司，百度、腾讯、阿里、滴滴、搜狗、360、京东、美团等等，让您拥有一流的开发人员！'
        },
        {
          src:'../static/images/rocket.jpg',
          title:'快速对接',
          isHover:false,
          description:'企业提出用人需求后，客服一对一对接，全程参与筛选人才，不管是工作日还是双休日的需求，当天即可确定对口人才！'
        },
        {
          src:'../static/images/money.jpg',
          title:'资金担保',
          isHover:false,
...
.whyChoose_item_icon_img{
  width: 150px;
  height: 150px;
}

.whyChoose_item_icon_img--hover{
  width: 160px;
  height: 160px;
}

.whyChoose_item_title{
  height: 15%;
  width: 80%;
  margin: 0 auto;
  font-size: 20px;
