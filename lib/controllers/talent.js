...
module.exports = {
	'POST /talent/getTalentList': getTalentList,//获取人才列表
    'POST /talent/editTalentInfo': editTalentInfo,//编辑保存人才信息
    'POST /talent/getSelfInfo': getSelfInfo,//获取人才个人信息（全部）
    'POST /talent/getEmployeeInfo': getEmployeeInfo,//获取人才信息（不全，保密数据未获取）
    'POST /talent/getOrderList': getOrderList,//获取人才订单列表
    'POST /talent/getApplyList': getApplyList,//获取已申请的项目列表
    'POST /talent/getRatingList': getRatingList//获取人才被评价列表
}