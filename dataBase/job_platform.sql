...
CREATE TABLE `apply` (
  `Apply_ID` bigint(20) NOT NULL COMMENT '每个申请的独特编号',
...
CREATE TABLE `log` (
  `Log_ID` bigint(20) NOT NULL COMMENT '每条log记录的唯一编号',
  `Project_ID` bigint(20) NOT NULL COMMENT '项目编号',
...
CREATE TABLE `operating` (
  `Operation_ID` bigint(20) NOT NULL COMMENT '操作记录的唯一ID',
...
CREATE TABLE `project` (
  `Project_ID` bigint(20) NOT NULL COMMENT '每个项目的唯一编号',
...
CREATE TABLE `rating` (
  `Rating_ID` bigint(20) NOT NULL COMMENT '每个评分的唯一编号',
  `Project_ID` bigint(20) NOT NULL COMMENT '项目编号',
